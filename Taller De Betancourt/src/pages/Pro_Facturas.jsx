...
function Pro_Facturas() {
  ...
  // Cargar datos con soporte para cancelación de petición
  ...
  // Cálculos derivados del estado actual del formulario
  ...
  const guardar = async (e) => {
    ...
    try {
      ...
      alertDark.fire({
        ...
        position: 'top-end',
        icon: 'success',
        title: esEdicion ? 'Factura actualizada' : 'Factura registrada',
