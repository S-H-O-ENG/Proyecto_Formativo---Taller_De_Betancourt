...
function guardarEvaluacion() {
    ...
    if (filaEditando) {
        ...
        filaEditando.innerHTML = crearFila(
            proveedor,
            tiempo,
            calidad,
            cumplimiento,
...
function actualizarPromedios() {
    ...
    document.getElementById("promTiempo").textContent =
        (sumaTiempo / filas.length).toFixed(1) + " /10";

    document.getElementById("promCalidad").textContent =
        (sumaCalidad / filas.length).toFixed(1) + " /10";

    document.getElementById("promCumplimiento").textContent =
        (sumaCumplimiento / filas.length).toFixed(1) + " /10";
